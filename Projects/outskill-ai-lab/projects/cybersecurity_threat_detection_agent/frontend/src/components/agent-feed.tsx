...
import type { TimelineEvent } from '@/stores/threat-store'
...
const COLOR_MAP: Record<string, string> = {
  agent_start: 'text-red-400',
  agent_end: 'text-green-400',
  tool_start: 'text-orange-400',
  tool_end: 'text-orange-400/50',
  handoff: 'text-amber-400',
  phase_change: 'text-rose-400',
